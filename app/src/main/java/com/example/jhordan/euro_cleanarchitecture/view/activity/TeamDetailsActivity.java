...
public class TeamDetailsActivity extends BaseActivity implements TeamDetailPresenter.View, HasSupportFragmentInjector {
    ...
    @BindView(R.id.label_coach)
    TextView labelCoach;
    @BindView(R.id.label_leading_scorer)
    TextView labelLeadingScorer;
    @BindView(R.id.label_stadium)
    TextView labelStadium;
    @BindView(R.id.label_description_1)
    TextView labelDescription1;
    @BindView(R.id.label_matches_played)
    TextView labelMatchesPlayed;
    @BindView(R.id.label_overall)
    TextView labelOverall;
    @BindView(R.id.label_final_tournament)
    TextView labelFinalTournament;
    @BindView(R.id.image_detail_profile)
    ImageView imageDetailProfile;
    @BindView(R.id.label_description_2)
    TextView labelDescription2;
    @BindView(R.id.label_description_3)
    TextView labelDescription3;
    ...
    @Override
    public void showTeam(TeamViewModel teamViewModel) {
